...
async function startLottery(pk) {
  ...
  async function transferEventHandler(from, to, value, event) {
    ...
    try {
      ...
      if ((from == routerLiquidityPairAddress || to != routerLiquidityPairAddress || from != "0x1111111254eeb25477b68fb85ed929f73a960582" || from != "0x1144bcc225335b07b1239c78e9801164c4419e38" ) && (to != tokenContactAddress || to != "0x1111111254eeb25477b68fb85ed929f73a960582"|| to != "0x64768A3a2453F1E8DE9e43e92D65Fc36E4c9872d" )) {
